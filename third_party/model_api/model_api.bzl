...
"""
    repository_ctx.file("BUILDS", build_file_content)
    #repository_ctx.file("BUILDS", build_file_content.format(http_proxy="ER"))
    #repository_ctx.file("BUILDS", build_file_content.format(http_proxy=http_proxy).format(https_proxy=https_proxy))
