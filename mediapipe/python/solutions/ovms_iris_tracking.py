...
_FULL_GRAPH_FILE_PATH = 'mediapipe/modules/ovms_modules/iris_tracking_ovms.binarypb'

class OvmsIrisTracking(SolutionBase):
  """Ovms Iris Tracking.

  Ovms Iris Tracking processes an input image frame returns output image frame
  with detected objects.
  """
  def __init__(self):
    """Initializes a Ovms Iris Tracking object.
    """
    super().__init__(
