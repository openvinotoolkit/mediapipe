 ...
 * License.
 */
#ifndef SEGMENTATION_OVERLAY_CALCULATOR_H_
#define SEGMENTATION_OVERLAY_CALCULATOR_H_
...
class SegmentationOverlayCalculator : public CalculatorBase {
 public:
...
#endif  // SEGMENTATION_OVERLAY_CALCULATOR_H_
